...
#ifndef STATISTICAL_FINANCIAL_DATA_PRICEHISTORYTWOYEARS_H
#define STATISTICAL_FINANCIAL_DATA_PRICEHISTORYTWOYEARS_H
...
class PriceHistoryTwoYears : public HTTPRequest, public ChartData{
public:
    PriceHistoryTwoYears();
    PriceHistoryTwoYears(std::string ticker);
    PriceHistoryTwoYears(const PriceHistoryTwoYears& priceHistory);
    void getVolume();
    void getClose();
    void getOpen();
...
#endif //STATISTICAL_FINANCIAL_DATA_PRICEHISTORYTWOYEARS_H
